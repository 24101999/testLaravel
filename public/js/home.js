...
var _require2 = __webpack_require__(/*! fontawesome */ "./node_modules/fontawesome/index.js"),
  commentPlus = _require2.commentPlus,
  link = _require2.link;
var _require3 = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"),
  add = _require3.add,
  remove = _require3.remove;
var _require4 = __webpack_require__(/*! postcss */ "./node_modules/postcss/lib/postcss.js"),
  Input = _require4.Input;
var _Vue = Vue,
  createApp = _Vue.createApp;
var button = document.getElementById('bt');
var textoCopiado = document.getElementById("textoCop");
...
createApp({
  ...
  methods: {
    ...
    closedCreate: function closedCreate() {
      this.ac = '';
    },
    get: function get() {
      var th = this;
      axios.get("http://127.0.0.1:8000/api").then(function (req) {
        ...
        var d = th.dados.map(function (el, i) {
          // console.log(el[i])
        });
      });
    },
    ...
    click: function click(e) {
      var _this = this;
      var per = document.querySelectorAll('.link');
      per.forEach(function (el, i) {
        _this.index = i;
        _this.element = i;
